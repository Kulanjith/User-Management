...
``` sh
storm jar target/core-1.0-SNAPSHOT.jar org.baeldung.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/core-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
